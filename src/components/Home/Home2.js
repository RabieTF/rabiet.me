          ...
          <Col md={8} className="home-about-description">
            <h1 style={{ fontSize: "2.6em" }}>
              <Trans i18nKey="homeIntroductionTitle">
                LEARN ABOUT <span className="purple">ME</span>
              </Trans>
            </h1>
            <p className="home-about-body">
              <Trans i18nKey="homeIntroductionContent">
                ...
                <br/> Currently, my main stack is <strong className="purple">Golang, React & AWS.</strong> I also use <strong className="purple">Wordpress</strong>. 
